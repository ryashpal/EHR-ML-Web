...
def getAnalysisConfigList(uid):
    ...
    analysisConfigList = []
    analysisPath = Path('data', uid, 'standardisation_analysis')
...
def analyse(uid, windowBefore, windowAfter, idColumns, targetColumn, measurementDateColumn, anchorDateColumn, ensembleModel):
    ...
    analysisPath = Path(dataDir, 'standardisation_analysis')
    ...
    from ehrml.analysis.StandardisationAnalysis import run
