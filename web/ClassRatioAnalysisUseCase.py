...
def getAnalysisConfigList(uid):
    ...
    analysisConfigList = []
    analysisPath = Path('data', uid, 'class_ratio_analysis')
...
def analyse(uid, windowBefore, windowAfter, idColumns, targetColumn, measurementDateColumn, anchorDateColumn, ensembleModel, pcpList):
    ...
    analysisPath = Path(dataDir, 'class_ratio_analysis')
    ...
    from ehrml.analysis.ClassRatioAnalysis import run
